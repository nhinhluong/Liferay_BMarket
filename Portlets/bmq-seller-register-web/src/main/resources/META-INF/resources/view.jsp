...
<div data-reactroot="" class="container">
	...
	<form action="<%=bmq_seller_regis%>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div>
							<select id="_BmqSellerRegisterWeb_store_type"
								...
								<option value="manufacturer">Nhà sản xuất (Sở hữu thương hiệu)</option>
								<option value="supplier">Nhà phân phối chính thức</option>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-8">
							<div class="form-group">
								...
								<div>
									<input id="_BmqSellerRegisterWeb_bank_name"
										class="form-control"
										name="_BmqSellerRegisterWeb_bank_name" value=""
										type="text">
								</div>
							</div>
						</div>
...
<script>
	YUI({
		...
		var datepicker1 = new Y.DatePicker({
			trigger : '#_BmqSellerRegisterWeb_date_founded',
			mask : '%d/%m/%Y',
			popover : {
				zIndex : 1
			}
